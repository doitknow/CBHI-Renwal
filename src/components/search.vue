<template>
  <div class="min-h-screen flex flex-col items-center justify-start bg-white">
    ...
    <div 
      class="relative w-full h-[80vh] flex flex-col items-center justify-center text-center text-white bg-cover bg-center bg-slide"
    >
 ...
 <div class="h-10 object-contain ml-4 mr-auto" >
  ...
  />
    ...
    <div class="w-full bg-lime-100 py-8 mt-auto overflow-hidden">rr1836498    robels1234
